export const TOPICS = [
  ...
  { id: 6, body: 'Be Careful What You Pray For ' },
  ...
  { id: 19, body: 'Does AA Meet Wants or Needs? ' },
  ...
  { id: 26, body: 'Finding a Higher Power ' },
  { id: 27, body: 'Finding God’s Will for Us ' },
  ...
  { id: 32, body: 'Growth through Prayer and Action' },
  { id: 33, body: 'Happy Coincidences ' },
  { id: 34, body: 'How Do You Think of God? ' },
  ...
  { id: 48, body: 'Needing the Program versus Wanting It ' },
  { id: 49, body: 'Old Resentments Flaring Up ' },
  { id: 50, body: 'Principles before Personalities ' },
  ...
  { id: 61, body: 'Trouble in Finding a Higher Power ' },
  ...
  { id: 80, body: 'When Have We Taken the Fifth Step? When I Feel Better, I’ll Do It! '},
